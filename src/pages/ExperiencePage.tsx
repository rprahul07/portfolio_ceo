...
const ExperiencePage = () => {
  ...
  return (
    <section
      className="min-h-screen w-full px-6 py-24 flex justify-center"
      style={{
        background: `
          radial-gradient(
            circle at top left,
          ...
          {experiences.map((exp, index) => (
            ...
            >
              ...
              {index < experiences.length - 1 && (
                <div
                  className="absolute left-8 top-24 w-0.5 h-full"
                  style={{
              ...
              <div className="flex gap-8">
                ...
                {/* Experience Card */}
                <div
                  className="flex-1 bg-black bg-opacity-50 backdrop-blur-sm rounded-2xl p-6 border border-purple-500 border-opacity-20"
                >
